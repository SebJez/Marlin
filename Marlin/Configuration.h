...
#define STRING_CONFIG_H_AUTHOR "(sebjez, Custom AnetA8/RAMPS)" // Who made the changes.
...
#define MACHINE_UUID "9c6827db-f09f-401c-a8f8-26e22a768c50"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kd 103.60
    // Tuned at 210C, no fan
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKi 53.51
  #define DEFAULT_bedKd 1042.70
...
//#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_Z_HOP       0.0        // (mm) Z height of nozzle between tramming points
